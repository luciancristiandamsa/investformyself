...
export default function BuildingWithOthersPage() {
  return (
    <main
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-16">
        ...
        <div className="bg-black/30 backdrop-blur-sm rounded-3xl p-8 shadow-lg mb-6 text-white">
          ...
          <p className="text-white/90">
            If partnership or shared life is part of your journey.
          </p>
        </div>
        ...
        <nav className="text-sm text-white/80 mb-10">
          ...
          →{" "}
          <span className="text-white">Building a Life With Others</span>
        </nav>
        ...
        <div className="bg-white/90 rounded-3xl p-8 shadow-md mb-16">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>• Choosing a partner consciously</li>
            <li>• Communication & emotional maturity</li>
            <li>• Aligning values</li>
            <li>• Shared finances</li>
            <li>• Time vs energy tradeoffs</li>
          </ul>
        </div>
      </div>
    </main>
